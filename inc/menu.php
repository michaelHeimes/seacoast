...
// The Top Menu
function seacoast_top_nav() {
	wp_nav_menu(array(
		'container'			=> false,						// Remove nav container
		'menu_id'			=> 'main-nav',					// Adding custom nav id
		'menu_class'		=> 'medium-horizontal menu',	// Adding custom nav class
		'items_wrap'		=> '<ul id="%1$s" class="%2$s" data-responsive-menu="accordion tablet-dropdown" data-submenu-toggle="true" data-hover-delay="200" data-closing-time="200" data-alignment="left">%3$s</ul>',
...
// The Off Canvas Menu
function seacoast_off_canvas_nav() {
	wp_nav_menu(array(
		'container'			=> false,							// Remove nav container
...
// The Footer Menu
function seacoast_footer_links() {
	wp_nav_menu(array(
		'container'			=> 'false',				// Remove nav container
...
function seacoast_social_links() {
	wp_nav_menu(array(
		'container'			=> 'false',				// Remove nav container
...
function seacoast_main_nav_fallback() {
	wp_page_menu( array(
		'show_home'		=> true,
...
function seacoast_footer_links_fallback() {
